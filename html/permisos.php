                        ...
                        <div class="span12">      		
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    ...
                                    <form class="form-horizontal" id="permisos_form" name="permisos_form" method="post">
                                        <div class="span6">
                                            <div class="control-group">											
                                                <label class="control-label" for="ci_usuario">Tipo Usuario:</label>
                                                <div class="controls">
                                                    <?php
                                                    ...
                                                    while ($row = pg_fetch_row($consulta)) {
                                                        if ($row[6] == 1) {
                                                            echo "<option value='$row[6]'>Administrador</option>";
                                                        } else {
                                                            if ($row[6] == 2) {
                                                                echo "<option value='$row[6]'>Vendedor</option>";
                                                            }
                                                        }
                                                    }
                                                    echo "</select>";
